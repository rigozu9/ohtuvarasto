...
def testaa_olut_setterit(olutta):
    print(f"Olutvarasto: {olutta}")
    print("olutta.lisaa_varastoon(1000.0)")
    olutta.lisaa_varastoon(1000.0)
    print(f"Olutvarasto: {olutta}")

def testaa_mehu_virheet(mehua):
    print(f"Mehuvarasto: {mehua}")
    print("mehua.lisaa_varastoon(-666.0)")
    mehua.lisaa_varastoon(-666.0)
    print(f"Mehuvarasto: {mehua}")

def testaa_olut_virheet(olutta):
    print(f"Olutvarasto: {olutta}")
...
def main():
    ...
    testaa_olut_setterit(olutta)
    testaa_mehu_virheet(mehua)
    testaa_olut_virheet(olutta)
